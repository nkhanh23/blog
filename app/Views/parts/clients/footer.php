        ...
        <script src="<?php _HOST_URL; ?>public/lib/easing/easing.min.js"></script>
        <script src="<?php _HOST_URL; ?>public/lib/waypoints/waypoints.min.js"></script>
        <script src="<?php _HOST_URL; ?>public/lib/owlcarousel/owl.carousel.min.js"></script>

        <!-- Template Javascript -->
        <script src="<?php _HOST_URL; ?>public/assets/js/main.js"></script>
        </body>
